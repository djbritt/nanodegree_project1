...
def movieInfo(id):
    ...
    storyline = unicodedata.normalize('NFKD',
                                      responseFormatted['overview']).encode('ascii','ignore')
    rating = unicodedata.normalize('NFKD',
                                   responseFormatted['release_dates']['results'][0]['release_dates'][0]['certification']).encode('ascii','ignore')
    return [title, storyline, poster, rating]

data = movieInfo(603)
theMatrix = movieClass.Movie(data[0],
                             data[1],
                             "https://image.tmdb.org/t/p/w500" + data[2],
                             "https://www.youtube.com/watch?v=m8e-FF8MsqU",
                             data[3])

data = movieInfo(11360)
dumbo = movieClass.Movie(data[0],
                         data[1],
                         "https://image.tmdb.org/t/p/w500" + data[2],
                         "https://www.youtube.com/watch?v=22v-1eMIl40",
                         data[3])

data = movieInfo(9078)
swordStone = movieClass.Movie(data[0],
                              data[1],
                              "https://image.tmdb.org/t/p/w500" + data[2],
...
data = movieInfo(218)
terminator = movieClass.Movie(data[0],
                              data[1],
                              "https://image.tmdb.org/t/p/w500" + data[2],
...
data = movieInfo(1635)
theIsland = movieClass.Movie(data[0],
                             data[1],
                             "https://image.tmdb.org/t/p/w500" + data[2],
...
data = movieInfo(8467)
dumber = movieClass.Movie(data[0],
                          data[1],
                          "https://image.tmdb.org/t/p/w500" + data[2],
